...
import { ipAttackGuard, registerFailedAttempt, clearFailedAttempts } from '../middlewares/ip-guard.middleware';
...
class UsuarioRoutes {
    ...
    config() {
        // RUTAS PÚBLICAS
        this.router.post('/login', ipAttackGuard, usuarioController.login);
